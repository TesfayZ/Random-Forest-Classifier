...
class TestMLFunctions(unittest.TestCase):
    ...
    def test_train_model(self):
        ...
        logging.info("train_model returned a RandomForestClassifier\
                      model instance")
    ...
    def test_evaluate_model(self):
        ...
        logging.info(
            "evaluate_model accuracy: %f, precision: %f, recall: %f, f1: %f",
            accuracy, precision, recall, f1)

    def test_save_model(self):
        """Test if the model, encoder, and label binarizer are saved."""
        ...
        save_model(model, encoder, lb, self.model_filepath,
                   self.encoder_filepath, self.lb_filepath)

        # Check if the files were created
        self.assertTrue(os.path.isfile(self.model_filepath),
